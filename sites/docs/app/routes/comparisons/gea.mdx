...
| Runtime model | Small shared, tree-shakeable execution kernel; no framework runtime | Application framework runtime with proxy reactivity and direct DOM patching |
