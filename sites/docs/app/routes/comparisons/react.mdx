---
title: React
description: Naos vs. React — a different corner, and why they are complementary.
order: 6
---
...
| Output ships to consumers | Generated element code plus a small shared kernel; **no framework runtime** | The **React runtime** (react + react-dom) |
...
| Distribution contract | The native Custom Element tag, framework-neutral | A React component (used inside React) |
...
### Framework runtime vs. a small shared kernel
...
virtual DOM or framework runtime handed to the consumer. Generated elements share
a small, tree-shakeable execution kernel for lifecycle and direct DOM mechanics.
...
- **Naos**: a **standards-based Custom Element** — a tag that any environment can
  use without knowing Naos or React exists.
...
is a native element a React app can then embed as a tag.
...
- Naos: the [project README](https://github.com/sebastian-software/naos-ui#readme)
  and the [React 19 adaptation review](https://github.com/sebastian-software/naos-ui/blob/main/docs/react-19-adaptation.md)
- React: [react.dev](https://react.dev/)
- React 19 release notes (incl. Custom Elements support):
  [react.dev/blog](https://react.dev/blog/2024/12/05/react-19)
