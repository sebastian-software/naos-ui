...
| Runtime model | Small shared, tree-shakeable execution kernel (~6 kB gzip complete); no framework runtime | Per-component runtime with a lightweight virtual DOM diff step |
