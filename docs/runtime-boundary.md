...
| Platform mechanics   | `emitter`, `hostApi`, `listen`, `setAttr`, `lazySheet`, `reconcileKeyed`                                                             | Wraps repeatable native browser behavior. Generated code supplies event names, DOM patches, list row construction, and application callbacks.             |
